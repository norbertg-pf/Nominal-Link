...
|---|---|---|
| Nominal SDK client/asset/dataset/write-stream handshake | `nominal_link` | Nominal protocol knowledge |
| Reconnect/backoff tunables | `nominal_link` | Network-behaviour tuning Nominal owns |
...
| Inter-process counters, the reconnect loop, block averaging | DAQUniversal | Host data pipeline |
